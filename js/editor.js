	...
	var methods = {
		...
		init : function( options )
		{
			...
			var menuItems = { 'fonteffects': true,
							 ...
							 'font_size': {	"select":true,
							  ...
							  'color'	: { "text":"A",
											...
											"custom":function(button){
													...
													var bgPallette    = $('<ul />',{id:"bgcolor_ui"}).append($('<li />').css({"width":"145px","display":"Block","height":"25px"}).html('<div>Color de</div>'));
						     ...
						     'ul'		: { "text": "Bullet", 
											"icon": "fa fa-list-ul", 
											"tooltip": "Insertar/Remover viñetas", 
						   ...
						   'insert_link': { "modal": true,
											...
											"onSave":function(){
												...
												if(targetURL ==''){
													methods.showMessage.apply(editorObj,["errMsg","Inserte url"]);
													return false;
												}												
												if(!targetURL.match(urlPattern)){
													methods.showMessage.apply(editorObj,["errMsg","Inserte un url válido"]);
													return false;
												}													
												if(range=='' && targetText==''){ 
						   ...
						   'insert_img'	: { "modal": true,
											...
											"onSave": function(){
												...
												if($('#imageList').data('current')){
													...
													methods.showMessage.apply(this,["imgErrMsg","Elegir una imagen"]);
													return false;
												}
						...
						'insert_table'	: { "modal": true,
						   ...
						   'indent'		: { "text": "Indent", 
											"icon":"fa fa-indent", 
											"tooltip": "Incrementar identación", 
											"commandname":"indent", 
											"custom":null },

						   'outdent'	: { "text": "Outdent", 
											"icon":"fa fa-outdent", 
											"tooltip": "Disminuir identación", 
											"commandname":"outdent", 
											"custom":null },
